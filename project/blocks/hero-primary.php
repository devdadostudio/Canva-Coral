...
<?php
				...
				<div class="wp-block-columns h-full items-end">
					<div class="wp-block-column col-span-12 md:col-span-9 lg:col-span-8 xl:col-span-6 pt-16 lg:pt-24">
						...
						<div class="_content-wrap isdark">
							...
							<p class="_title fs-huge ani-text-in">
								' . get_field('title') . '
								<span class="_subtitle fs-h2">
								' . get_field('subtitle') . '
								</span>
							</p>
	...
	canva_the_layer([
		'layer_type' => '_hero _hero-primary min-h-hero-tall', // _hero, _card, _photobutton
		...
		'layer_content' => 'on',
		'layer_content_class' => '_main__section py-16 relative w-full',
