...
<div id="<?php echo esc_attr($id); ?>" class="wp-block-photobutton">
	...
	<?php if ($link_wrap) : ?>
		...
		?>
		<div class="_pb-type-b _photobutton _pb-fixed-ratio ratio-4-5 lg:ratio-16-9 _layer-wrap<?php echo esc_attr($class_name); ?> <?php echo esc_attr($isdark); ?>">
			...
			<div class="_layer-visual absolute">
				...
				<div class="_layer-filter" style="top:60%"></div>

				<!-- <?php if ($photobutton_toptitle) : ?>
					<div class="_layer-graphics overflow-visible">
						<span class="v-r absolute block left-6 md:left-8 bottom-6 md:bottom-8"><?php echo $photobutton_toptitle; ?></span>
					</div>
				<?php endif; ?> -->
			...
			<!-- Layer content -->
			<div class="_layer-content absolute" style="top:60%;height:40%">
				...
				<div class="_content-wrap wp-block-columns h-full p-6 lg:p-8">
						<div class="wp-block-column col-span-12 md:col-span-6">
							<?php if ($photobutton_title) : ?>
								<span class="_pb-title block h4 fw-400 lh-11 line-clamp-3 mb-0"><?php echo $photobutton_title; ?></span>
							<?php endif; ?>
						...
						<div class="wp-block-column col-span-12 md:col-span-6 flex items-end justify-end">
							<?php if ($photobutton_toptitle) : ?>
								<span class="v-r inline-flex"><?php echo $photobutton_toptitle ;?></span>
							<?php endif; ?>
						</div>
				</div>
			</div>
