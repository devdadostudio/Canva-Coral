...
<div id="<?php echo esc_attr($id); ?>" class="wp-block-photobutton">
		...
		<?php if ($link_wrap) : ?>
			...
			?>
			<div class="_block-pb-news _photobutton _pb-fixed-ratio ratio-4-3 _layer-wrap<?php echo esc_attr($class_name); ?> <?php echo esc_attr($isdark); ?>">
				...
				<div class="_layer-visual absolute">
					...
					<div class="_layer-filter top-1/4"></div>
				...
				<!-- Layer content -->
				<div class="_layer-content absolute top-1/4">
					...
					<?php if ($icon) : ?>
						...
						<?php if ($photobutton_title) : ?>
							<h3 class="_pb-title block h3 lh-11 mb-0"><?php echo $photobutton_title; ?></h3>
						<?php endif; ?>
