...
<div id="<?php echo esc_attr($id); ?>" class="wp-block-photobutton">
	...
	<?php if ($link_wrap) : ?>
		...
		?>
		<div class="_pb-type-a _photobutton _pb-fixed-ratio ratio-4-5 lg:ratio-4-3 _layer-wrap <?php echo esc_attr($class_name); ?> <?php echo esc_attr($isdark); ?>">
			...
			<!-- Layer content -->
			<div class="_layer-content absolute h-full isdark">
				...
				<div class="_content-wrap flex flex-col justify-around h-full p-6 lg:p-8">
					...
					<?php if ($photobutton_title) : ?>
						<h3 class="_pb-title block fs-h3 lg:fs-h2 lh-11 mb-0"><?php echo $photobutton_title; ?></h3>
					<?php endif; ?>
					...
					<?php endif; ?>
					<!-- <?php if ($photobutton_toptitle) : ?>
						<span class="v-r block"><?php echo $photobutton_toptitle; ?></h3>
					<?php endif; ?> -->
