...
<div id="<?php echo esc_attr($id); ?>" class="wp-block-photobutton">
		...
		<?php if ($link_wrap) : ?>
			...
			?>
			<div class="_pb-type-b _photobutton _pb-fixed-ratio ratio-4-3 _layer-wrap<?php echo esc_attr($class_name); ?> <?php echo esc_attr($isdark); ?>">
				...
				<div class="_layer-visual absolute">
					...
					<div class="_layer-filter top-1/3"></div>
				...
				<!-- Layer content -->
				<div class="_layer-content absolute top-1/3">
					...
					<div class="_content-wrap h-full p-6 lg:p-8">
