...
if (is_admin()) {
	...
	$template = [
		...
		['core/columns', ['className' => 'max-w-screen-xxl mx-auto'], [
...
?>
	...
	<div class="canva-wp-block <?php echo esc_attr($hide . ' ' . $staff_preview); ?>" style="border: 1px dashed #aaaaaa;">
		...
		<div class="canva-info canva-flex align-middle">
			...
			<div class="canva-p-4">
				<span class="title canva-block canva-mb-2 canva-fs-xxsmall canva-font-system canva-lh-12" style=""><?php _e('Row Width XXL', 'canva-backend'); ?></span>
