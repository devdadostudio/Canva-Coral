...
function canva_be_acf_init()
{
	...
	if (function_exists('acf_register_block_type')) {
		...
		acf_register_block([
			'name' 				=> 'posts-selector-slider', //modificare slug del blocco
			'title' 			=> __('Posts Selector Slider', 'canva-backend'), //modificare titolo del blocco
			'description' 		=> __('Select Posts Slider to be presented with a custom template', 'canva-backend'), //modificare azione del blocco
			'render_callback' 	=> 'canva_be_block_callback', //non modificare
			'category' 			=> 'canva_block_category', //non modificare
			'icon' 				=> apply_filters('posts_selector_preview_blocks_icon', canva_get_svg_icon('canva-icons/canva-icon-posts-selector-preview', null)),
			'keywords' 			=> ['Posts', 'Selector', 'Slide', 'Slider', 'Swiper'],
			'supports'			=> array('align' => false, 'multiple' => true, 'anchor' => true),
		]);
		...
		acf_register_block([
			'name' 				=> 'micro-template-loader', //modificare slug del blocco
			'title' 			=> __('Micro Template Loader', 'canva-backend'), //modificare titolo del blocco
			'description' 		=> __('Add a micro template', 'canva-backend'), //modificare azione del blocco
			'render_callback'	=> 'canva_be_block_callback', //non modificare
			'category'			=> 'canva_block_category', //non modificare
			'icon' 				=> 'align-wide',
			'keywords'			=> array('Micro Template', 'Template'),
			'supports'			=> array('align' => false, 'multiple' => true, 'anchor' => true),
		]);
