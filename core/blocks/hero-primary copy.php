...
<?php
	...
	if (get_field('toptitle') || get_field('title') || get_field('subtitle') || get_field('action_link') || get_field('action_link_2') || get_field('post_object')) {
		$layer_content_output .= '
